...
\includegraphics[width=0.8\linewidth]{resistenza_Re200_en.png}
...
\end{figure}
\begin{figure}[p]\centering
\includegraphics[width=0.8\linewidth]{ottimo_3D_en.png}
\caption{Axisymmetric optimal bodies.}\label{fig:opt3d}
\end{figure}
\begin{figure}[p]\centering
\includegraphics[width=0.8\linewidth]{mappa_finale_en.png}
...
\end{figure}
\begin{figure}[p]\centering
\includegraphics[width=0.8\linewidth]{cfd_conv_1e6f_en.png}
\caption{RANS versus reduced-order model, bare body at $\ReV=10^6$.}\label{fig:cfdconv}
\end{figure}
\begin{figure}[p]\centering
\includegraphics[width=0.8\linewidth]{carena_flusso_en.png}
